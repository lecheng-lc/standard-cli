...
import { Options } from '../common/constant.js'
...
export const addPlop = (addType: boolean, options: Options) => {
  const plopInfo = {
    plop: '^3.0.5',
  }
 ...
 */
export const addHusky = (addType: boolean, options: Options) => {
  const huskyInfo = {
    husky: '^7.0.4',
  }
...
export const addCmLint = (addType: boolean, options: Options) => {
...
export const addPretter = (addType: boolean, options: Options) => {
  const destDir = CWD
...
export const addEslint = async (addType: boolean, options: Options) => {
  const destDir = CWD
...
export const addTS = (addType: boolean, options: Options) => {
  const destDir = CWD
  if (proType === 'wxMini') {
    const eslintInfo = {
      typescript: '^4.6.2',
