import fs, { existsSync, mkdirSync, writeFileSync,accessSync,appendFile } from 'fs'
import path from 'path'
import chalk from 'chalk'
const Log = console.log
export function writeFileBy(filePath:string,desDir:string){
  try {
 ...
 */
export function fsMkdir(filePath: string) {
  // try {
 ...
 * @param desDir 
 */
export function customCopyFile(srcDir:string, desDir:string, exclude?:string[]) {
   try {
